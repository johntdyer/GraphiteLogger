 ...
 * following would save the value 480.72 at UNIX timestamp 1234567890:
 * <code> targeting.api.requests.sc9.tgt101 480.72 1234567890\n * </code>
 * <p>
...
public class GraphiteInterface {
   ...
   *          is the server name hosting Graphite such as
   *          "graphite.sc9.admob.int".
   * @param graphitePort
   *          is the port number the server is listening on (default is 2003).
   * @param system
   *          is the name of this service such as "targeting".
   */
   ...
   *          "graphite.sc9.admob.int".
   * @param system
   *          is the name of this service such as "targeting". It is turned into
   *          lower case so our top-level folders have the same naming
   *          convension.
   */
   ...
   * 
   * @param seconds
   *          is the number of seconds between each stats update.
   */
   ...
   * 
   * @param input
   *          is all the statistics to record in Graphite's format. See
